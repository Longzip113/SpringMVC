						...
						<div class="form-group">
							  ...
							  <div class="col-sm-9">
							  	 <form:select path="categoryCode" id="categoryCode">
							  	 	...
							  	 	<form:options items="${categorys}"/> <!-- yêu cầu chuyền vào là một cái map() -->
							  	 </form:select>
							  </div>
						</div>
						<div class="form-group">
								...
								<div class="col-sm-9">
									<!-- path="title" tương đương với name && value -->
...
<script>
	$('#btnAddOrUpdateNew').click(function (e) {
	    ...
	    var formData = $('#formSubmit').serializeArray(); // lay gia tri cua các thẻ index là name && value tạo thành mảng oject
